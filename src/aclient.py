...
from g4f.Provider import (
    ...
    #Free2GPT,  # Removed in new g4f
    #FreeGpt,   # China lang only :c
    #GizAI,     # Removed in new g4f
    #Glider,    # Removed in new g4f
    GeminiPro,
...
def _initialize_providers():
    ...
    providers_dict = {
        "gpt-4o-mini": [DDGS, PollinationsAI],
        "gpt-4o": [PollinationsAI],
        "o3-mini": [DDGS, PollinationsAI],
        "blackboxai": [BlackboxPro],
        "command-r-plus": [HuggingSpace, HuggingChat],
        "command-r7b-12-2024": [HuggingSpace],
        "claude-3.7-sonnet": [BlackboxPro],
        "gemini-1.5-flash": [GeminiPro],
        "gemini-1.5-pro": [GeminiPro],
        "gemini-2.0-flash": [GeminiPro],
        "gemini-2.0-flash-thinking": [GeminiPro],
        "llama-3.1-405b": [BlackboxPro],
        "llama-3.2-11b": [HuggingChat], # Vision
        "llama-3.3-70b": [HuggingChat, BlackboxPro],
        "qwq-32b": [BlackboxPro, HuggingChat],
        ...
        "deepseek-chat": [PollinationsAI, BlackboxPro],
        "deepseek-v3": [BlackboxPro],
        "deepseek-r1": [HuggingChat, BlackboxPro],
        "mixtral-small-24b": [DDGS],
        "glm-4": [GLM],
            ...
            try:
                ...
                if provider in self.clients_by_provider:
                    ...
                    if provider == GeminiPro:
                        client_instance = AsyncClient(provider=provider, api_key=os.getenv("GOOGLE_API_KEY"))
                    else:
